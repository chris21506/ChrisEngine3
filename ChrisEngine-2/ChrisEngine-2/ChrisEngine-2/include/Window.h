...
/**
 * @file ChrisEngine2Window.h
 * @brief Wrapper ligero alrededor de sf::RenderWindow (SFML 3) con utilidades comunes para ChrisEngine-2.
 *
 * - Renderiza los personajes: princesa.png, sonic.png, virdo.png, wario.png
 * - Renderiza la pista: pista de carreras.png
 */
class ChrisEngine2Window {
public:
    /**
     * @brief Constructor por defecto (no crea la ventana todavía).
     */
    ChrisEngine2Window() = default;

    /**
     * @brief Crea la ventana con tamaño y título.
     * @param width Ancho en píxeles.
     * @param height Alto en píxeles.
     * @param title Título de la ventana.
     */
    ChrisEngine2Window(int width, int height, const std::string& title);
